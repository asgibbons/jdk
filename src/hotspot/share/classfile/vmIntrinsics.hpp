...
#define VM_INTRINSICS_DO(do_intrinsic, do_class, do_name, do_signature, do_alias)                                       \
  ...
  do_intrinsic(_bigIntegerLeftShiftWorker, java_math_BigInteger, leftShift_name, big_integer_shift_worker_signature, F_S) \
   do_name(     leftShift_name,                                 "shiftLeftImplWorker")                                  \
                                                                                                                        \
  do_intrinsic(_oddModPow_20,            java_math_BigInteger, oddModPow_20_name, oddModPow_signature, F_S)          \
   do_name(     oddModPow_20_name,                             "oddModPow_20")                                          \
                                                                                                                        \
  do_intrinsic(_oddModPow_30,            java_math_BigInteger, oddModPow_30_name, oddModPow_signature, F_S)          \
   do_name(     oddModPow_30_name,                             "oddModPow_30")                                          \
                                                                                                                        \
  do_intrinsic(_oddModPow_40,            java_math_BigInteger, oddModPow_40_name, oddModPow_signature, F_S)          \
